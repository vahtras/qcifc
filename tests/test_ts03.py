...
class TestTS03(TestQC):
    ...
    @pytest.mark.parametrize(
        'args',
        [
            ('x', 'x', (0,), {('x', 'x', 0): -6.170983965659e+00}),
            ('y', 'y', (0,), {('y', 'y', 0): -6.898637187471e+00}),
            ('z', 'z', (0,), {('z', 'z', 0): -1.316801827723e+01}),
            ('x', 'x', (0.5,), {('x', 'x', 0.5): -9.135810700766e+00}),
            ('y', 'y', (0.5,), {('y', 'y', 0.5): -1.009994305958e+01}),
            ('z', 'z', (0.5,), {('z', 'z', 0.5): -1.840879740097e+01}),
        ],
